...
- The home page opens in the new Body systems workspace. Eight systems each contain three selectable structures. System search, structure selection and specimen switching use local React state.
